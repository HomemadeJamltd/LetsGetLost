...
-(void) KMLParserFilenameError:(NSString*) filename;
...
@property (unsafe_unretained, nonatomic, readonly) NSArray *circleOverlays;
...
@property (unsafe_unretained, nonatomic, readonly) NSArray *regions;
